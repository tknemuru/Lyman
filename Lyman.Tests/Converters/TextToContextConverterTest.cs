...
namespace Lyman.Tests
{
    ...
    public class TextToContextConverterTest : BaseUnitTest<TextToContextConverter>
    {
        ...
        public void 手牌の読み込みができる()
        {
            ...
            Wind.ForEach((wind) =>
            {
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
                expected.Hands[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
            });
            ...
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
            expected.Hands[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
            Assert.AreEqual(expected, actual);
        }
        ...
        public void 河の読み込みができる()
        {
            ...
            Wind.ForEach((wind) =>
            {
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
                expected.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
            ...
            actual = this.Target.Convert(input);
            expected = DiProvider.GetContainer().GetInstance<FieldContext>();
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
            expected.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
