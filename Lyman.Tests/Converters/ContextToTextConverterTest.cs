...
namespace Lyman.Tests
{
    ...
    public class ContextToTextConverterTest : BaseUnitTest<ContextToTextConverter>
    {
        ...
        public void 河の書き込みができる()
        {
            ...
            Wind.ForEach((wind) =>
            {
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
                context.Rivers[wind.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
            ...
            // 002:一部の風のみ存在する
            context = DiProvider.GetContainer().GetInstance<FieldContext>();
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 1));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 2));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 3));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.WhiteDragon));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.GreenDragon));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.RedDragon));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Characters, 4));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Bamboos, 5, true));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.Circles, 6));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.East));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.West));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.South));
            context.Rivers[Wind.Index.South.ToInt()].Add(Tile.BuildTile(Tile.Kind.North));
